<?php   
        ...
        $q=mysqli_query($con,"SELECT * FROM user WHERE iduser='$iduser'") or die (mysqli_error());  
...
<?php }elseif($r['level']=='superuser'){ ?>
              ...
              <ul class="list-unstyled">
			   ...
			   <li><a href="?modul=waitress">Waitress</a></li>
                          ...
                          <li><a href="?modul=user2">User2</a></li>
                        </ul>
                  </li>
    ...
    <section class="content">
        ...
        <footer class="container-fluid footer">
        	Copyright &copy; 2016 <a href="#" >Bery's Coffee and Food @Pradipta</a>
