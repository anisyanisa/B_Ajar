...
$a=mysql_query("select * from menu,menukategori,kategori where kategori.id_kategori=menukategori.id_kategori AND menukategori.id_menu=menu.id_menu AND kategori.id_kategori='$kategori' order by kategori.id_kategori") or die(mysql_error());

$rk=mysql_query("select * from kategori where id_kategori='$kategori'");
