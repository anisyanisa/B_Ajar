...
<?php
$first=mysql_query("select * from kategori");
$no=1;
while ($rfirst=mysql_fetch_array($first)){ 
//$total=$total+$aa['jlh'];
?>
...
<?php
$def=mysql_query("select * from menu,menukategori,kategori where kategori.id_kategori=menukategori.id_kategori AND menukategori.id_menu=menu.id_menu AND kategori.id_kategori='$rfirst[id_kategori]' order by kategori.id_kategori");
while($rdef=mysql_fetch_array($def)){?>
...
$a=mysql_query("select * from menu,menukategori,kategori where kategori.id_kategori=menukategori.id_kategori AND menukategori.id_menu=menu.id_menu order by kategori.id_kategori") or die(mysql_error());
