   ...
   <div class="panel-heading">
    <div class="row">
     ...
     <div class="col-xs-9 text-right">
      <div class="huge">
       <?php echo $this->m_sisfo->get_data('dosen')->num_rows(); ?>
  ...
  <div class="panel panel-success">
   <div class="panel-heading">
    <div class="row">
     ...
     <div class="col-xs-9 text-right">
      <div class="huge">
      <?php echo $this->m_sisfo->get_data('mahasiswa')->num_rows(); ?>
    ...
    <div class="row">
     ...
     <div class="col-xs-9 text-right">
      <div class="huge"> 
       ...
       <?php echo $this->m_sisfo->get_data('Matakuliah')->num_rows();
?>



     </div>
      <div>Jumlah Matakuliah</div>
     </div>
    </div>
   </div>
   ...
   <div class="panel-body">
    <div class="list-group">
     ...
     <a href="#" class="list-group-item">
      <span class="badge"><?php //if($m>mobil_status == 1){echo "Tersedia";}else{echo "Dirental";}
...
?>
    ...
    <div class="text-right">
     <a href="<?php echo
base_url().'admin/mobil' ?>">Lihat Semua Mobil <i class="glyphicon
...
class="glyphicon glyphicon-arrow-right"></i></a>
 ...
 <div class="col-lg-5"> 
  <div class="panel panel-default"> 
   <div class="panel-heading">
    <h3 class="panel-title"><i class="glyphicon 
      glyphicon-sort"></i> Peminjaman Terakhir</h3>
   </div>
   <div class="panel-body">
